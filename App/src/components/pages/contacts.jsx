            ...
            <div className='container'>
                <div className={contacts.contactscontentTextPack}>
                    <div className={contacts.contactscontentCard}>
                        ...
                        <span className={contacts.contactscontentCardSubtitle}><img alt='location' className={contacts.contactscontentCardImage} src={location} />Невский 140, офис 1-5</span>
                    ...
                    <div className={contacts.contactscontentCard}>
                        ...
                        <span className={contacts.contactscontentCardSubtitle}><img alt='phone' className={contacts.contactscontentCardImage} src={phone} /> 8 (812) 458-56-45</span>
                    ...
                    <div className={contacts.contactscontentCard}>
                        ...
                        <span className={contacts.contactscontentCardSubtitle}><img alt='message' className={contacts.contactscontentCardImage} src={message} />office@ojjo.com</span>
                    ...
                    <div className={contacts.contactscontentCard}>
                        ...
                        <span className={contacts.contactscontentCardSubtitle}><img alt='location' className={contacts.contactscontentCardImage} src={location} /> Невский 142, офис 1-5</span>
